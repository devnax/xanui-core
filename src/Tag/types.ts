...
export type TagProps<T extends TagComponentType = "div"> = Omit<
  React.HTMLProps<T>,
  "width" | "height"
> & {
  component?: T;
...
export interface TagCSSProperties {
  ...
  boxShadow: CSSValueType<"boxShadow"> | BreakpointKeys;
  ...
  margin: CSSValueType<"margin"> | BreakpointKeys;
  ...
  marginBottom: CSSValueType<"marginBottom"> | BreakpointKeys;
  ...
  marginLeft: CSSValueType<"marginLeft"> | BreakpointKeys;
  marginRight: CSSValueType<"marginRight"> | BreakpointKeys;
  marginTop: CSSValueType<"marginTop"> | BreakpointKeys;
  ...
  padding: CSSValueType<"padding"> | BreakpointKeys;
  ...
  paddingBottom: CSSValueType<"paddingBottom"> | BreakpointKeys;
  ...
  paddingLeft: CSSValueType<"paddingLeft"> | BreakpointKeys;
  paddingRight: CSSValueType<"paddingRight"> | BreakpointKeys;
  paddingTop: CSSValueType<"paddingTop"> | BreakpointKeys;
...
export type CSSPropAsAttr = Partial<TagCSSProperties> &
  Aliases & {
    baseClass?: string;
    sx?: CSSProps;
    hover?: CSSProps;
